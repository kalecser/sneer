...
abstract class AbstractDownloadOld implements Download {
	...
	AbstractDownloadOld(File path, long lastModified, Hash hashOfFile, Seal source, boolean copyLocalFiles) {
		_actualPath = path;
	...
	public boolean equals(Object obj) {
		...
		AbstractDownloadOld other = (AbstractDownloadOld) obj;
		if (_hash == null) {
			if (other._hash != null)
				return false;
