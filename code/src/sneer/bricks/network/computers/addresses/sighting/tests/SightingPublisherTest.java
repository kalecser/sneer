...
public class SightingPublisherTest extends BrickTestBase {
	...
	public void testSightingsAreConvertedToTuples(){
		...
		see("foo", "10.42.10.42");
		assertSightingKept("foo", "10.42.10.42");
	}

	
	private void assertSightingKept(final String seal, final String ip) {
