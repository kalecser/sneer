...
class OutgoingAttempt {
	...
	private final TcpConnectionManager _socketConnectionManager = my(TcpConnectionManager.class);
	...
	private boolean hasSocketAlready() {
		return _socketConnectionManager.connectionFor(contact()).isConnected().currentValue();
	}
