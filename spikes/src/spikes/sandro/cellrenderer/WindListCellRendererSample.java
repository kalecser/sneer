...
class WindListCellRendererSample implements ListCellRenderer<Object> {
	...
	private static void initGui() {
		...
		ListCellRenderer<Object> renderer = new WindListCellRendererSample(new LabelProvider<String>(){
